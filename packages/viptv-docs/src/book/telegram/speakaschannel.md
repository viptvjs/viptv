...
# Telegram 在群组中使用频道身份发言

::: tip

此功能仅限 Telegram Premium，更多关于 Premium 的介绍请参阅[此处](/tgwiki/premium)
...
2. 在群组中输入框左侧有个头像，点击就可以切换选择频道，就可以用频道身份发言了。（如果输入框左侧没有，更新最新 TG 并重启 TG 客户端）

3. 部分群组中使用了 Bot 或 UserBot 禁止使用频道身份发言，使用频道身份发言前请注意。

4. 对于频道的创建者，没有 Telegram Premium，也可以在该频道的关联群组内使用频道身份发言。

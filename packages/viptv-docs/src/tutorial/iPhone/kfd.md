...
![](https://img.viptv.work/viptv/kfd/misaka-01.png)

下载完成后，点击浏览器 `下载` 按键，再点击已经下载好的 `misaka`

![](https://img.viptv.work/viptv/kfd/misaka-02.png)


右上角分享，选择 `牛蛙助手`

![](https://img.viptv.work/viptv/kfd/misaka-03.png)
...
![](https://img.viptv.work/viptv/kfd/misaka-04.png)


点击 `misaka` ，选择 `签名` - `立即签名`

![](https://img.viptv.work/viptv/kfd/misaka-05.png)
...
![](https://img.viptv.work/viptv/kfd/misaka-06.png)

设置 - VPN - 勾选 `牛蛙助手` - 打开VPN开关

![](https://img.viptv.work/viptv/kfd/misaka-07.png)

打开VPN后我们返回重新安装 misaka 即可

![](https://img.viptv.work/viptv/kfd/misaka-08.png)
...
![](https://img.viptv.work/viptv/kfd/misaka-09.png)


设置 - 通用 - VPN与设备管理 - 选择 开发者APP - `信任`

![](https://img.viptv.work/viptv/kfd/misaka-10.png)

![](https://img.viptv.work/viptv/kfd/misaka-11.png)


再次打开 misaka ，提示沙盒读写，点 `好`

![](https://img.viptv.work/viptv/kfd/misaka-12.png)

允许 `无限局域网与蜂窝数据`，但是提示 `Network Erro`


![](https://img.viptv.work/viptv/kfd/misaka-13.png)

这时我们需要使用 [科学上网](../gfw/proxy) ，我用小火箭，机场用的超级机场

![](https://img.viptv.work/viptv/kfd/misaka-14.png)

连接好再次打开 misaka，`Agree` 同意后进入主界面

![](https://img.viptv.work/viptv/kfd/misaka-15.png)


左上角 Setting - App Language

![](https://img.viptv.work/viptv/kfd/misaka-16.png)

选择 `zh_CN` 完成后，自动退出，再次进入就能看到已经汉化了，下滑可退出页面


![](https://img.viptv.work/viptv/kfd/misaka-17.png)
...
![](https://img.viptv.work/viptv/kfd/misaka-18.png)
...
![](https://img.viptv.work/viptv/kfd/misaka-19.png)

这里我就选虚拟定位，进去后点 `get`

![](https://img.viptv.work/viptv/kfd/misaka-20.png)

显示队列中了，点一下底部查看，安装确认

![](https://img.viptv.work/viptv/kfd/misaka-21.png)

安装成功后，在底部软件包里可以看到

![](https://img.viptv.work/viptv/kfd/misaka-22.png)

点 `Simulation Start` 开始模拟位置，在地图上选择你要定位的位置，close关闭

![](https://img.viptv.work/viptv/kfd/misaka-23.png)
...
![](https://img.viptv.work/viptv/kfd/misaka-24.png)
...
![](https://img.viptv.work/viptv/kfd/misaka-25.png)



不想要插件了，长按卸载，点开底部队列表，确认卸载即可

![](https://img.viptv.work/viptv/kfd/misaka-26.png)

![](https://img.viptv.work/viptv/kfd/misaka-27.png)

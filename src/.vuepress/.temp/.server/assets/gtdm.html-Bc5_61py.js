...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      const lzcaiji = await vod.find({ "name": "lzcaiji-gtdm" });
      const bfzy = await vod.find({ "name": "bfzy-gtdm" });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/vod/dongman/gtdm.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const gtdm_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "gtdm.html.vue"]]);

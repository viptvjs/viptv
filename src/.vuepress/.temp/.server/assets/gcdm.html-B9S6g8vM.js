  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Tabs, {
        id: "2",
        data: [{ "id": "魔都资源" }, { "id": "索尼资源" }, { "id": "量子资源" }, { "id": "暴风资源" }],
        active: 0
      }, {
        ...
        title3: withCtx(({ value, isActive }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`暴风资源`);
          } else {
            return [
        ...
        tab0: withCtx(({ value, isActive }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(unref(state).vodmd, (item, k) => {
            ...
            return [
              (openBlock(true), createBlock(
                Fragment,
                null,
                renderList(unref(state).vodmd, (item, k) => {
        ...
        tab3: withCtx(({ value, isActive }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/vod/dongman/gcdm.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const gcdm_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "gcdm.html.vue"]]);
const data = JSON.parse('{"path":"/vod/dongman/gcdm.html","title":"国产动漫","lang":"zh-CN","frontmatter":{"title":"国产动漫","icon":"person-falling-burst","date":"2020-01-01T00:00:00.000Z","order":4,"category":["影视点播"],"tag":["动漫"],"head":[["meta",{"property":"og:url","content":"https://DESKTOP-BB2QNSK/vod/dongman/gcdm.html"}],["meta",{"property":"og:site_name","content":"VIPTV"}],["meta",{"property":"og:title","content":"国产动漫"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-05-08T12:19:44.000Z"}],["meta",{"property":"article:author","content":"Mr.Hefung"}],["meta",{"property":"article:tag","content":"动漫"}],["meta",{"property":"article:published_time","content":"2020-01-01T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-05-08T12:19:44.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"国产动漫\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2020-01-01T00:00:00.000Z\\",\\"dateModified\\":\\"2024-05-08T12:19:44.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"Mr.Hefung\\",\\"url\\":\\"/\\"}]}"]]},"headers":[],"git":{"createdTime":1714993694000,"updatedTime":1715170784000,"contributors":[{"name":"viptv","email":"mail@viptv.work","commits":4}]},"readingTime":{"minutes":0.98,"words":293},"filePathRelative":"vod/dongman/gcdm.md","localizedDate":"2020年1月1日","excerpt":""}');
export {
  gcdm_html as comp,
  data
};

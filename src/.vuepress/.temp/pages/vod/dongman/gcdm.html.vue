<template><div><ArtPlayer :src="state.src" :config="artPlayerConfig" /><Tabs id="2" :data='[{"id":"魔都资源"},{"id":"索尼资源"},{"id":"量子资源"},{"id":"暴风资源"}]' :active="0">
<template #title0="{ value, isActive }">魔都资源</template>
<template #title1="{ value, isActive }">索尼资源</template>
<template #title2="{ value, isActive }">量子资源</template>
<template #title3="{ value, isActive }">暴风资源</template>

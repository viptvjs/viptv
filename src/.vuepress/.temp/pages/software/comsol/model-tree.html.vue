...
<h2 id="组件和研究节点" tabindex="-1"><a class="header-anchor" href="#组件和研究节点"><span>组件和研究节点</span></a></h2>
...
<h2 id="结果节点" tabindex="-1"><a class="header-anchor" href="#结果节点"><span>结果节点</span></a></h2>
...
<h2 id="参数、函数、变量和范围" tabindex="-1"><a class="header-anchor" href="#参数、函数、变量和范围"><span>参数、函数、变量和范围</span></a></h2>
<h3 id="全局参数" tabindex="-1"><a class="header-anchor" href="#全局参数"><span>全局参数</span></a></h3>
...
<h3 id="结果参数" tabindex="-1"><a class="header-anchor" href="#结果参数"><span>结果参数</span></a></h3>
...
<h3 id="app-中使用的变量" tabindex="-1"><a class="header-anchor" href="#app-中使用的变量"><span>App 中使用的变量 <Badge text="高级用法" /></span></a></h3>
<p>模型参数和变量可在 App 中使用。例如，您可以让 App 用户更改参数值。此外，还可以在 “App 开发器”中 App 树的声明节点下定义要在 App 中使用的变量。此类变量也能在模型方法中使用。</p>
<h3 id="范围" tabindex="-1"><a class="header-anchor" href="#范围"><span>范围</span></a></h3>

<template><div><h2 id="显式选择" tabindex="-1"><a class="header-anchor" href="#显式选择"><span>显式选择</span></a></h2>
...
<h2 id="布尔选择和相邻选择" tabindex="-1"><a class="header-anchor" href="#布尔选择和相邻选择"><span>布尔选择和相邻选择</span></a></h2>
...
<h2 id="基于坐标的选择" tabindex="-1"><a class="header-anchor" href="#基于坐标的选择"><span>基于坐标的选择</span></a></h2>
<div class="hint-container tip">
<p class="hint-container-title">提示</p>

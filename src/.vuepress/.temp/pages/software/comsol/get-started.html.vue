<template><div><p>本章简单介绍如何在 COMSOL Multiphysics<sup>®</sup> 中建立和运行有限元模型。</p>
<!-- more -->
<h2 id="comsol-建模流程" tabindex="-1"><a class="header-anchor" href="#comsol-建模流程"><span>COMSOL 建模流程</span></a></h2>
<p>建模工作流程包含以下步骤:</p>
<ul>
<li>建立模型环境</li>
<li>构建几何图形</li>
...
<h2 id="用户页面" tabindex="-1"><a class="header-anchor" href="#用户页面"><span>用户页面</span></a></h2>
...
<figure><img src="@source/software/comsol/assets/layout.png" alt="COMSOL 界面" tabindex="0" loading="lazy"><figcaption>COMSOL 界面</figcaption></figure>
<h2 id="模型开发器和-app-开发器" tabindex="-1"><a class="header-anchor" href="#模型开发器和-app-开发器"><span>模型开发器和 App 开发器</span></a></h2>
...
<h2 id="模型开发器" tabindex="-1"><a class="header-anchor" href="#模型开发器"><span>模型开发器</span></a></h2>
...
<h3 id="快速访问工具栏" tabindex="-1"><a class="header-anchor" href="#快速访问工具栏"><span>快速访问工具栏</span></a></h3>
<p>“快速访问工具栏”可供您访问各种功能，例如打开、保存、撤消、重做、复制、粘贴以及删除。可以从定制快速访问工具栏列表(工具栏右侧的向下箭头)中定制其内容。</p>
<h3 id="功能区" tabindex="-1"><a class="header-anchor" href="#功能区"><span>功能区</span></a></h3>
...
<div class="hint-container tip">
<p class="hint-container-title">其他选项卡</p>
...
<h2 id="设置窗口" tabindex="-1"><a class="header-anchor" href="#设置窗口"><span>设置窗口</span></a></h2>
...
<h2 id="绘图窗口" tabindex="-1"><a class="header-anchor" href="#绘图窗口"><span>绘图窗口</span></a></h2>
...
<h2 id="信息窗口" tabindex="-1"><a class="header-anchor" href="#信息窗口"><span>信息窗口</span></a></h2>
...
<div class="hint-container tip">
<p class="hint-container-title">带取消按钮的进度条</p>
<p>在软件中进行解算或执行其他操作时，桌面右下角会出现一个进度条用于表明正当前正在执行的任何操作或计算的状态。进度条旁边有个红色的 “X” 符号，用来取消操作。</p>
</div>
<h2 id="其他窗口" tabindex="-1"><a class="header-anchor" href="#其他窗口"><span>其他窗口</span></a></h2>
...
<h3 id="动态帮助" tabindex="-1"><a class="header-anchor" href="#动态帮助"><span>动态帮助</span></a></h3>
...
<h2 id="app-开发器" tabindex="-1"><a class="header-anchor" href="#app-开发器"><span>App 开发器 <Badge text="高级用法" /></span></a></h2>
...
<h2 id="内置常数、变量和函数" tabindex="-1"><a class="header-anchor" href="#内置常数、变量和函数"><span>内置常数、变量和函数</span></a></h2>
...
<p>以下是一些重要示例:</p>
<ul>
<li>数学常数 (如 <code v-pre>pi</code> (3.14...))或虚部单位 <code v-pre>i</code> 或 <code v-pre>j</code></li>
<li>物理常数，如 <code v-pre>g_const</code> (重力加速度)、<code v-pre>c_const</code> (光速)或 <code v-pre>R_const</code> (通用气体常数)</li>
<li>时间变量，<code v-pre>t</code></li>
<li>因变量 (解)的一阶和二阶导数，其名称派生自空间坐标名称和因变量名称(用户定义的变量)</li>
<li>数学函数，如 <code v-pre>cos</code>、<code v-pre>sin</code>、<code v-pre>exp</code>、<code v-pre>log</code>、<code v-pre>log10</code> 和 <code v-pre>sqrt</code></li>
</ul>
</div></template>

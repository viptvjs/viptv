...
<div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre v-pre class="language-json"><code>    <span class="token property">"workbench.editor.openPositioning"</span><span class="token operator">:</span> <span class="token string">"left"</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="预览模式" tabindex="-1"><a class="header-anchor" href="#预览模式"><span>预览模式</span></a></h2>

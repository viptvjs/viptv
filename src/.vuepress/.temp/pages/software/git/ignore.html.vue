...
<div class="language-gitignore line-numbers-mode" data-ext="gitignore" data-title="gitignore"><pre v-pre class="language-gitignore"><code><span class="token entry string">Thumbs.db</span>
<span class="token entry string">ehthumbs.db</span>
<span class="token entry string">Desktop.ini</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后，继续忽略 Python 编译产生的 <code v-pre>.pyc</code>、<code v-pre>.pyo</code>、<code v-pre>dist</code> 等文件或目录:</p>
<div class="language-gitignore line-numbers-mode" data-ext="gitignore" data-title="gitignore"><pre v-pre class="language-gitignore"><code><span class="token entry string">_.py<span class="token regex">[cod]</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>加上您自己定义的文件，最终得到一个完整的 <code v-pre>.gitignore</code> 文件，内容如下:</p>
<div class="language-gitignore line-numbers-mode" data-ext="gitignore" data-title="gitignore"><pre v-pre class="language-gitignore"><code><span class="token comment"># Windows:</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code>$ <span class="token function">git</span> <span class="token function">add</span> App.class
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果您确实想添加该文件，可以用 <code v-pre>-f</code> 强制添加到 Git:</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">git</span> <span class="token function">add</span> <span class="token parameter variable">-f</span> App.class
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>或者您发现，可能是 <code v-pre>.gitignore</code> 写得有问题，需要找出来到底哪个规则写错了，可以用 <code v-pre>git check-ignore</code> 命令检查:</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code>$ <span class="token function">git</span> check-ignore <span class="token parameter variable">-v</span> App.class
.gitignore:3:*.class    App.class
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>Git 会告诉我们，<code v-pre>.gitignore</code> 的第 3 行规则忽略了该文件，于是我们就可以知道应该修订哪个规则。</p>
...
<p>一个具体的例子:</p>
<div class="language-gitignore line-numbers-mode" data-ext="gitignore" data-title="gitignore"><pre v-pre class="language-gitignore"><code><span class="token comment"># 忽略所有的 .a 文件</span>
...
<p>GitHub 有一个十分详细的针对数十种项目及语言的 .gitignore 文件列表， 您可以在 <a href="https://github.com/github/gitignore" target="_blank" rel="noopener noreferrer">https://github.com/github/gitignore<ExternalLinkIcon/></a> 找到它。</p>
</div>
<div class="hint-container tip">

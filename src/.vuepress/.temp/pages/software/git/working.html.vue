<template><div><p>Git 究竟是怎样的一个系统呢? 尽管 Git 用起来与其它的版本控制系统非常相似，但它在对信息的存储和认知方式上却有很大差异。</p>
<h2 id="直接记录快照-而非差异比较" tabindex="-1"><a class="header-anchor" href="#直接记录快照-而非差异比较"><span>直接记录快照，而非差异比较</span></a></h2>
...
<figure><img src="@source/software/git/assets/delta-based.png" alt="基于差异" tabindex="0" loading="lazy"><figcaption>基于差异</figcaption></figure>
...
<figure><img src="@source/software/git/assets/snapshot.png" alt="基于快照" tabindex="0" loading="lazy"><figcaption>基于快照</figcaption></figure>
<h2 id="近乎所有操作都是本地执行" tabindex="-1"><a class="header-anchor" href="#近乎所有操作都是本地执行"><span>近乎所有操作都是本地执行</span></a></h2>
...
<h2 id="git-保证完整性" tabindex="-1"><a class="header-anchor" href="#git-保证完整性"><span>Git 保证完整性</span></a></h2>
...
<h2 id="git-一般只添加数据" tabindex="-1"><a class="header-anchor" href="#git-一般只添加数据"><span>Git 一般只添加数据</span></a></h2>
...
<h2 id="三种状态" tabindex="-1"><a class="header-anchor" href="#三种状态"><span>三种状态</span></a></h2>

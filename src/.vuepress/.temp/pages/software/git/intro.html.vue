<template><div><p>Git 是什么?</p>
<p>Git 是目前世界上最先进的分布式版本控制系统(没有之一)。</p>
<!-- more -->
<h2 id="版本控制系统" tabindex="-1"><a class="header-anchor" href="#版本控制系统"><span>版本控制系统</span></a></h2>
...
<h3 id="本地版本控制系统" tabindex="-1"><a class="header-anchor" href="#本地版本控制系统"><span>本地版本控制系统</span></a></h3>
...
<figure><img src="@source/software/git/assets/RCS.png" alt="本地版本控制系统" tabindex="0" loading="lazy"><figcaption>本地版本控制系统</figcaption></figure>
...
<h3 id="集中化的版本控制系统" tabindex="-1"><a class="header-anchor" href="#集中化的版本控制系统"><span>集中化的版本控制系统</span></a></h3>
...
<figure><img src="@source/software/git/assets/intro.jpg" alt="Git示例图" tabindex="0" loading="lazy"><figcaption>Git示例图</figcaption></figure>
...
<h3 id="分布式版本控制系统" tabindex="-1"><a class="header-anchor" href="#分布式版本控制系统"><span>分布式版本控制系统</span></a></h3>
...
<figure><img src="@source/software/git/assets/DVCS.png" alt="分布式版本控制系统" tabindex="0" loading="lazy"><figcaption>分布式版本控制系统</figcaption></figure>
<div class="hint-container tip">

<template><div><h1 id="linux-系统启动过程" tabindex="-1"><a class="header-anchor" href="#linux-系统启动过程"><span>Linux 系统启动过程</span></a></h1>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code>l5:5:wait:/etc/rc.d/rc <span class="token number">5</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这一行表示以 5 为参数运行 <code v-pre>/etc/rc.d/rc</code>，<code v-pre>/etc/rc.d/rc</code> 是一个 Shell 脚本，它接受 5 作为参数，去执行 <code v-pre>/etc/rc.d/rc5.d/</code> 目录下的所有的 rc 启动脚本，<code v-pre>/etc/rc.d/rc5.d/</code> 目录中的这些启动脚本实际上都是一些连接文件，而不是真正的 rc 启动脚本，真正的 rc 启动脚本实际上都是放在 <code v-pre>/etc/rc.d/init.d/</code>目录下。</p>

<template><div><p>Linux 中大量使用脚本语言，而不是 C 语言!</p>
<!-- more -->
...
<p>为什么不选择 C 语言呢?</p>
<h2 id="c-语言并不是最佳选择" tabindex="-1"><a class="header-anchor" href="#c-语言并不是最佳选择"><span>C 语言并不是最佳选择</span></a></h2>
...
<h2 id="脚本语言也有不足" tabindex="-1"><a class="header-anchor" href="#脚本语言也有不足"><span>脚本语言也有不足</span></a></h2>

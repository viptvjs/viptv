...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token comment"># .bash_profile</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">bash</span> <span class="token parameter variable">--login</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>bash</code> 命令的 <code v-pre>--noprofile</code> 参数，会跳过上面这些 Profile 脚本。</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">bash</span> <span class="token parameter variable">--noprofile</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="非登录-session" tabindex="-1"><a class="header-anchor" href="#非登录-session"><span>非登录 Session</span></a></h3>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">bash</span> <span class="token parameter variable">--norc</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>bash</code> 命令的 <code v-pre>--rcfile</code> 参数，指定另一个脚本代替 <code v-pre>.bashrc</code>。</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">bash</span> <span class="token parameter variable">--rcfile</span> testrc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="bash-logout" tabindex="-1"><a class="header-anchor" href="#bash-logout"><span>.bash_logout</span></a></h3>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token function">bash</span> <span class="token parameter variable">-n</span> scriptname
<span class="token function">bash</span> <span class="token parameter variable">-v</span> scriptname
<span class="token function">bash</span> <span class="token parameter variable">-x</span> scriptname
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="键盘绑定" tabindex="-1"><a class="header-anchor" href="#键盘绑定"><span>键盘绑定</span></a></h2>
...
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="token variable">$include</span> /etc/inputrc
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code v-pre>.inputrc</code> 文件里面的快捷键，可以像这样定义，<code v-pre>&quot;\C-t&quot;:&quot;pwd\n&quot;</code> 表示将 <code v-pre>Ctrl + t</code> 绑定为运行 <code v-pre>pwd</code> 命令。</p>
</div></template>

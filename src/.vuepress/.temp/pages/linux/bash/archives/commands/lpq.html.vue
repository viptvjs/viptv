<template><div><h1 id="lpq" tabindex="-1"><a class="header-anchor" href="#lpq"><span>lpq</span></a></h1>
<p><code v-pre>lpq</code> 命令显示打印机队列。</p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code>$ lpq

        ...
        <div class="vuemastery-modal-container">
          ...
          <div class="vuemastery-modal-footer">
            <p class="vuemastery-modal-footer-text">
              Video by
              <a href="https://www.vuemastery.com" target="_blank" rel="sponsored noopener"
                title="Vue.js Courses on Vue Mastery">
                Vue Mastery.</a> Watch Vue Mastery’s free
              <a href="https://www.vuemastery.com/courses/intro-to-vue-3/intro-to-vue3" target="_blank"
                rel="sponsored noopener" title="Vue.js Courses on Vue Mastery">

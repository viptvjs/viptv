...
let GlobalMusicList: string | any[] = [];
  ...
  <ClientOnly>
    <div class="MyMusic">
      <div class="MyMusic_Play" :class="{ hide: !IsShow }">
        <VPIcon class="close"  absolute right-10 top-10 size-30 flex-center cursor-pointer color-grey opacity-40 icon="xmark" @click="CloseStatus" />
